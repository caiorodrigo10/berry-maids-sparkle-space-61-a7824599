...
const EstimateDisclaimer = () => {
  ...
  return <section className="bg-berry-purple text-white py-16">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm opacity-80 mb-8">Factors that can affect the final price include: Size of the home, number of bedrooms, bathrooms, additional services, level of cleanliness and more.</p>
          <Button onClick={scrollToEstimator} className="bg-berry-lime text-black hover:bg-berry-lime/90 font-semibold text-lg px-8 py-6">
